            ...
            <div class="col l9 col m12 col s12">
                <div class="blockquote z-depth-1">
                    <div class="breadcrumb"><a href="{{ route('home') }}">Home</a> <i class="fa fa-angle-right"></i><a
                                href="{{ route('member.dashboard') }}">Profile</a> <i class="fa fa-angle-right"></i>
                        Change Password
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col m6 s12">
                            ...
                            <div class="input-field">
                                ...
                                {!! Form::password('old_password', '', array('class'=>'validate', 'placeholder' => 'Old Password' )) !!}
                                <label for="old_password">Old Password</label>
                            </div>
                            <div class="input-field">
                                <i class="mdi-action-lock-open prefix"></i>
                                {!! Form::password('password', '', array('class'=>'validate', 'placeholder' => 'New Password' )) !!}
                            ...
                            <button style="margin-left:3rem"
                                    ...
                                    type="submit" name="action">Change Password
                            </button>
                            {!! csrf_field() !!}
