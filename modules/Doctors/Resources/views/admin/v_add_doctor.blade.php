...
@section('main')
    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            ...
            @endif
            <form action="{{ route('admin.doctors.addSubmit') }}" method="post" class="row" role="form"
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control input-sm" name="contact" id="" value="{{ old('contact') }}"
                ...
                {!! csrf_field() !!}
                <div class="col-sm-4">
                    <button type="submit" class="btn btn-primary btn-sm m-t-5">Add Doctor</button>
                </div>
            </form>
        </div>
    </div>
