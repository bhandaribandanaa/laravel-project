...
@section('main')
    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            ...
            @endif
            <form action="{{ route('admin.doctors.editSubmit') }}" method="post" class="row" role="form"
                  enctype="multipart/form-data" id="contentForm">

                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        <label class="" for="exampleInputEmail2">Full Name *</label>
                        <input type="text" class="form-control input-sm" name="full_name" id="" value="{{ $doctor->full_name }}"
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        <label class="" for="">Specialization *</label>
                        <select name="specialization_id" id="" class="selectpicker">
                            <option value="">Choose a specialization</option>
                            @foreach($spec as $s)
                                <option value="{{ $s->id }}" @if($s->id== $doctor->specialization_id) selected @endif> {{ $s->title }} </option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control input-sm" name="contact" id="" value="{{ $doctor->contact }}"
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control input-sm" name="address" id="" value="{{ $doctor->address }}"
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="3"
                                  placeholder="Meta description">{!! $doctor->description !!}</textarea>
                    </div>
                </div>
               ...
               <div class="col-sm-6">
                  <div class="form-group fg-line">
                     ...
                     <div style="padding:10px 0;">Note <span style="color: red">*</span> : Image size must be : 600 x 480px<br/></div>
                        <div>
