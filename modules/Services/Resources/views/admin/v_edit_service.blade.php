    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body card-padding">
                <form action="{{ route('admin.services.editSubmit') }}" method="post" class="row" role="form" id="profile" enctype="multipart/form-data">
                    <div class="col-sm-6">
                        <div class="form-group fg-line">
                            <label class="" for="exampleInputEmail2">Title</label>
                            <input type="text" class="form-control input-sm" name="title"
                                   id="exampleInputEmail2" value="{{ $service->title }}"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group fg-line">
                            ...
                            <select name="icon">
                                <option value="{{ $service->icon }}" selected="true"> </option>
                        ...
                        <div class="form-group fg-line">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                    @if($service->image !='')<img src="{{ asset('uploads/services/'.$service->image) }}"> @endif
                                </div>
                                <div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group fg-line">
                            ...
                            <textarea class="form-control description" name="description" style="height: 600px;">
                                {{ $service->description }}
                            </textarea>
                        </div>
