...
@section('main')
    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            ...
            @endif
            <form action="{{ route('admin.packages.editSubmit') }}" method="post" class="row" role="form"
                  enctype="multipart/form-data" id="contentForm">

                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        <label class="" for="exampleInputEmail2">Title *</label>
                        <input type="text" class="form-control input-sm" name="title" id="" value="{{ $package->title }}"
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="3"
                                  placeholder="Meta description">{!! $package->description !!}</textarea>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control input-sm" name="price" id="" value="{{ $package->price }}"
