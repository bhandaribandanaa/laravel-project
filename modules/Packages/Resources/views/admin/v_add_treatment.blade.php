    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                ...
                @endif
                <form action="{{ route('admin.packages.addTreatmentSubmit') }}" method="post" class="row" role="form"
                    ...
                    <div class="col-sm-12">
                        <div class="form-group fg-line">
                            ...
                            @foreach($packages as $pack)
                                <label><input name="packages[]" type="checkbox" value="{{ $pack->id }}">{{ $pack->title }}</label>
                            @endforeach
                    ...
                    {!! csrf_field() !!}
                    <div class="col-sm-4">
                        <button type="submit" class="btn btn-primary btn-sm m-t-5">Add Treatment</button>
                    </div>
                </form>
            </div>
        </div>
