    ...
    <section id="page_header">
        <div class="page_title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="title">Book {{ $package->title }} with Dr. {{ $doctor->full_name }}</h2>
                        <div class="page_link"><a href="{{ route('home') }}">Packages</a><i class="fa fa-long-arrow-right"></i><span>{{ $package->title }}</span><i class="fa fa-long-arrow-right"></i><span>Appointment with Dr. {{ $doctor->full_name }}</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="padding">
        <div class="container">
            <div class="row">
                ...
                @endif
                <div class="col-md-12">
                    <form class="callus" id="contact_form" style="margin-top:0" method="post" action="{{ route('packages.book') }}">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    <select name="shift" id="" class="selectpicker" required>
