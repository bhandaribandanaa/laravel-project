...
@section('main')
    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            ...
            <form action="{{ route('admin.download.file.add') }}" method="post" class="row" role="form"
                ...
                <div class="col-sm-6">
                    <div class="form-group fg-line">
                        ...
                        {!! Form::select('access_type', array( '1' => 'Public','0' => 'Members Only'), '', ['class'=>'selectpicker form-control input-sm','placeholder'=>'Select Access Type']) !!}
                    </div>
                </div>
