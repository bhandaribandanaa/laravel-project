...
@section('main')
    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            ...
            <form action="{{ route('admin.download.category.add') }}" method="post" class="row" role="form"
                ...
                {!! csrf_field() !!}
                <div class="col-sm-4">
                    <button type="submit" class="btn btn-primary btn-sm m-t-5">Add Category</button>
                </div>
            </form>
        </div>
    </div>
