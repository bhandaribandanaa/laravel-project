...
@section('main')
    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            ...
            @endif
            <form action="{{ route('admin.content.add') }}" method="post" class="row" role="form"
                  enctype="multipart/form-data" id="contentForm">

                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        <label class="" for="exampleInputEmail2">Heading *</label>
                        <input type="text" class="form-control input-sm" name="heading" id="" value="{{ Input::old('heading') }}"
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control input-sm" name="page_title" id="" value="{{ Input::old('page_title') }}"
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control input-sm" name="meta_tags" id="" value="{{ Input::old('meta_tags') }}"
                               placeholder="Enter Title">
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <textarea name="meta_description" class="form-control" rows="3"
                                  placeholder="Meta description">{{ Input::old('meta_description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    {!! Form::select('display_in[]', $menu_location, '', array('class'=>'selectpicker',"multiple"=>"true")) !!}
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group fg-line">
                        ...
                        <textarea name="short_description" class="form-control" rows="5"
                                  placeholder="Meta description">{{ Input::old('short_description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group fg-line">
                        ...
                        <textarea class="form-control" name="content" style="height: 300px;">{{ Input::old('content') }}</textarea>
                        </textarea>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control col-xs-3 input-sm" name="display_order" id=""
                               placeholder="Display Order" value="{{ Input::old('display_order') }}">
                    </div>
                </div>
