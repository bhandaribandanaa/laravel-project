    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h2>Add News Category
                    <small></small>
                </h2>
            </div>
            <div class="card-body card-padding">
                <form action="{{ route('admin.news.addCategorySubmit') }}" method="post" class="row" role="form" id="profile" enctype="multipart/form-data">
                    <div class="col-sm-6">
                        <div class="form-group fg-line">
                            <label class="" for="exampleInputEmail2">Category*</label>
                            <input type="text" class="form-control input-sm" name="category"
                                   id="exampleInputEmail2" value="{{ old('category') }}"
                    ...
                    {!! csrf_field() !!}
                    <div class="col-sm-4">
                        <button type="submit" class="btn btn-primary btn-sm m-t-5">Add News Category</button>
                    </div>
                </form>
            </div>
        </div>
