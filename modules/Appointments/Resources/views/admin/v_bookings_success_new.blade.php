            ...
            <div class="card cardstyle" style="margin-bottom:0;">
                <div class="card-header ch-alt ">
                    <ul class="nav nav-pills nav-justified row">
                        ...
                        <li class="col-xs-12 col-sm-4 col-md-4 active"><a href="{{ route('admin.appointments.successfulPackages') }}">Successful</a></li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.change-confirm').click(function (event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("admin.appointments.change_confirmPackage") }}',
