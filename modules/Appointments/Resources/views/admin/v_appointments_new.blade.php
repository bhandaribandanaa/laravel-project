        ...
        <div class="card cardstyle" style="margin-bottom:0;">
            <div class="card-header ch-alt ">
                <ul class="nav nav-pills nav-justified row">
                    <li class=" col-xs-12 col-sm-4 col-md-4 active"><a href="{{ route('admin.appointments.index') }}">Confirmed</a></li>
                ...
                <table class="table table-striped datatable">
                    ...
                    @forelse($conf_app as $app)
                        ...
                        <tr>
                            ...
                            <td>{{ $app->date }}</td>
                            <td class="fonts">
                                <a class="btn btn-primary btn-icon waves-effect waves-circle waves-float waves-effect waves-circle waves-float zmdi zmdi-eye " data-toggle="modal" data-target="#myModal{{$i}}" data-toggle="tooltip" title="View Details"></a>
                                <!-- Modal -->
