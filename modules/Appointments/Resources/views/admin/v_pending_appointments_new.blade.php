        ...
        <div class="card">
            ...
            <div class="card-header ch-alt ">
                <ul class="nav nav-pills nav-justified row">
                    ...
                    <li class="col-xs-12 col-sm-4 col-md-4"><a href="{{ route('admin.appointments.successful') }}">Successful</a></li>
                    <li class="col-xs-12 col-sm-4 col-md-4 active"><a href="{{ route('admin.appointments.pending') }}">Requests</a></li>
                        ...
                        <tr>
                            ...
                            <td class="fonts">
                                ...
                                @if($app->is_confirmed == 1)
                                    <a href="javascript:void(0)" class="change-status btn btn-primary btn-icon waves-effect waves-circle waves-float waves-effect waves-circle waves-float" id="{!! $app->id !!}"  data-toggle="tooltip" title="Confirm Booking"><i
                                ...
                                <a href="{{ route('admin.appointments.changeSchedule',[$app->id, $app->doctor_id]) }}" class="btn btn-primary btn-icon waves-effect waves-circle waves-float waves-effect waves-circle waves-float" id="{!! $app->id !!}"  data-toggle="tooltip" title="Change Schedule"><i
