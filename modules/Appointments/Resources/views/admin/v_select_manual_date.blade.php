...
@section('header_css')
    <style>
		...
		div.zabuto_calendar .table{ border:1px solid #f0f0f0 !important;}
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                <form action="{{ route('admin.appointments.manualAppointmentFinal') }}" method="post">
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                append += "<div class='col-sm-4'>"+
                                    "<button type='submit' class='btn btn-primary btn-sm m-t-5'>Complete Appointment</button>"+
