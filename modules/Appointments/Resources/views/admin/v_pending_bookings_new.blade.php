    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card cardstyle" style="margin-bottom:0;">
                <div class="card-header ch-alt ">
                    <ul class="nav nav-pills nav-justified row">
                        <li class=" col-xs-12 col-sm-4 col-md-4 "><a href="{{ route('admin.appointments.packages') }}">Confirmed</a></li>
                        <li class="col-xs-12 col-sm-4 col-md-4"><a href="{{ route('admin.appointments.successfulPackages') }}">Successful</a></li>
                        <li class="col-xs-12 col-sm-4 col-md-4 active"><a href="{{ route('admin.appointments.pendingPackages') }}">Requests</a></li>
            ...
            <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="myModal{{$i++}}" class="modal fade" role="dialog">
                                    ...
                                    <a href="#" class="change-status btn btn-primary btn-icon waves-effect waves-circle waves-float waves-effect waves-circle waves-float" id="{!! $app->id !!}"  data-toggle="tooltip" title="Switch to Confirm Mode"><i
                                                class="zmdi zmdi-lock zmdi-hc-fw"></i></a>

                                <a href="{{ route('admin.appointments.changeSchedulePackage',[$app->id, $app->doctor_id]) }}" class="btn btn-primary btn-icon waves-effect waves-circle waves-float waves-effect waves-circle waves-float" id="{!! $app->id !!}"  data-toggle="tooltip" title="Change Schedule"><i
                                            class="zmdi zmdi-code zmdi-hc-fw"></i></a>
                ...
                <div align="center">
                    {!! $unconf_app->appends(Input::only('doctor','date'))->render() !!}
                </div>
