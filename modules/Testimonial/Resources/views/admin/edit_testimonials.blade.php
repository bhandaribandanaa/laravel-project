    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            ...
            <form action="{{ route('admin.testimonial.edit',$testimonial->id) }}" method="post" class="row" role="form"
                        ...
                        <div class="form-group fg-line">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                    <img id="testimonialsImage" src="{{ asset('uploads/testimonials/'.$testimonials->image) }}">
                ...
                {!! csrf_field() !!}
                <div class="col-sm-4">
                    <button type="submit" class="btn btn-primary btn-sm m-t-5">Update Testimonial</button>
                </div>
            </form>
        </div>
    </div>
