    ...
    <div id="rev-slider2" class="rev_slider fullwidthabanner">
        <ul>
            ...
            <li data-transition="random">
                <!-- Main Image -->
                <img src="{{ asset('sadik/img/slider/6.jpg') }}" alt="" data-bgposition="center center"
                ...
                <div class="sfb tp-caption tp-resizeme text-white text-shadow text-center"
                    ...
                    We will make your building construction project proceed in a straight forward manner.
                </div>
            ...
            <li data-transition="random">
                <!-- Main Image -->
                <img src="{{ asset('sadik/img/slider/7.jpg') }}" alt="" data-bgposition="center center"
                     data-bgfit="cover" data-bgrepeat="no-repeat" data-no-retina>
                <!-- Layers -->
                <div class="sfb tp-caption tp-resizeme text-white font-family-heading text-shadow text-center font-weight-700 letter-spacing-2px"
                     data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                ...
                <div class="sfb tp-caption tp-resizeme text-white text-shadow text-center"
                    ...
                    We provide expertise and genuine commitment to quality on every project no matter the size.
